...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: '/dashboard/selebgram',
        name: 'Selebgram',
        redirect: '/selebgram/campaign',
      },
      // campaign
      {
        path: '/dashboard/selebgram/campaign',
        name: 'Campaign',
        component: {
          render() {
        ...
        children: [
          {
            path: '/selebgram/campaign',
            name: '',
            component: Campaign,
          },
          {
            path: '/selebgram/campaign/detail',
      ...
      // channel
      {
        path: '/dashboard/selebgram/channel',
        name: 'Channel',
        component: {
          render() {
            return h(resolveComponent('router-view'))
        ...
        redirect: '/selebgram/channel',
        children: [
          {
            path: '/selebgram/channel',
            name: '',
            component: Channel,
          },
          {
            path: '/selebgram/channel/form',
            name: 'Form Channel',
