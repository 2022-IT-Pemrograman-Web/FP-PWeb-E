...
<template>
	<div class="s-campaignDetail">
		<h3 class="col" style="margin-bottom: 30px">Tambah Campaign</h3>
				...
				<form @submit.prevent="handleSubmit" method="post" style="padding: 30px 30px">
					...
					<div class="row d-flex justify-content-center mt-3">
						<div class="d-flex justify-content-end">
							<button class="btn btn-success ps-5 pe-5" type="submit" style="padding: 5px 20px 5px 20px; color: white">Apply</button>
						</div>
					</div>
				</form>
			</CCardBody>
